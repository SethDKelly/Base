...
Phase 003 turns viable candidates into explicit concept specifications. It is the point at which a proposed concept must become understandable through its own purpose and observable behavior rather than merely through a name or feature description.

## Methodological intention

Specify each viable concept through the design information needed to explain what it means and how it fulfills its purpose: purpose, operational principle, abstract state, actions, conditions, effects, outputs, invariants, and other relevant user-visible semantics.
...
- action semantics;
- relevant preconditions, effects, outputs, and invariants;
- intrinsic authority, lifecycle, temporal, correction, or historical semantics where applicable;
- unresolved specification questions to be challenged in Phase 004.
...
Candidate concepts are sufficiently mature to justify detailed behavioral examination without assuming that their current boundaries are correct.
