...
- What coherent subsets of the concept system constitute sensible products or variants?
...
- Are there application variants whose concept sets require different synchronization or mapping considerations later?
...
- concept-inclusion dependency model;
- required/optional/conditional concept relationships;
- coherent subset or product-family definitions;
- application-scope boundaries;
- identified variant-specific constraints;
- unresolved mapping implications for Phase 007.
...
The phase may exit when extrinsic concept dependencies are explicit; coherent subsets and product-family boundaries are understandable; hidden intrinsic dependence has not been normalized as product dependence; and the resulting application scopes are ready to be mapped into user-visible behavior.

## Control structure

The phase begins with a mandatory `006-A` start gate, which derives the project-specific dependence, subset, and scope-analysis subphases. The final subphase is the Phase 006 consolidation, exit review, and handoff.
